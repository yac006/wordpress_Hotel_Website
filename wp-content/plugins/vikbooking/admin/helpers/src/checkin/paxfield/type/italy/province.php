...
/**
 * Defines the handler for a pax field of type "italy_province".
 * 
 * @since 	1.15.0 (J) - 1.5.0 (WP)
 */
final class VBOCheckinPaxfieldTypeItalyProvince extends VBOCheckinPaxfieldType
{
	/**
	...
	public function render()
	{
		if (substr($this->field->getKey(), -2) == '_s' && $this->field->getGuestNumber() > 1) {
			// this is rather "provincia di residenza" and we are parsing the Nth guest
			return '';
		}
