...
class VikBookingViewCarat extends JViewVikBooking {
	...
	protected function addToolBar() {
		JToolBarHelper::title(JText::translate('VBMAINCARATTITLE'), 'vikbooking');
		if (JFactory::getUser()->authorise('core.create', 'com_vikbooking')) {
			JToolBarHelper::addNew('newcarat', JText::translate('VBMAINCARATNEW'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.edit', 'com_vikbooking')) {
			JToolBarHelper::editList('editcarat', JText::translate('VBMAINCARATEDIT'));
			JToolBarHelper::spacer();
		}
		if (JFactory::getUser()->authorise('core.delete', 'com_vikbooking')) {
			JToolBarHelper::deleteList(JText::translate('VBDELCONFIRM'), 'removecarat', JText::translate('VBMAINCARATDEL'));
			JToolBarHelper::spacer();
		}
	}
